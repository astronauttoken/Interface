var w = can.width = window.innerWidth,
  ...
  document.getElementById('blue_orb').style.height = (h + (h * 0.25)) + 'px';
...
opts = {
    ...
    repaintColor: '#02051f',
    connectionColor: '#bc7cb2',
    rootColor: '#bc7cb2',
    endColor: '#bc7cb2',
    dataColor: '#3dafc2',

    wireframeWidth: .5,
    wireframeColor: '#bc7cb2',
...
window.addEventListener('resize', function() {
  ...
  opts.vanishPoint.x = (w = can.width = window.innerWidth) / 2;
  opts.vanishPoint.y = (h = can.height = window.innerHeight) / 2;
  ctx.fillRect(0, 0, w, h);

  document.getElementById('blue_orb').style.height = (h + 100) + 'px';
});
...
function explore_now() {
  ...
  opts.rotVelY = .01;
	...
	document.getElementById('blue_orb').style.animationDuration = "10s";

  setTimeout(function() {
		opts.rotVelX = .0005;
		opts.rotVelY = .0005;
		document.getElementById('blue_orb').style.animationDuration = "200s";
  }, 1200);
